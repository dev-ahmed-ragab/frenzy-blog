...
function Navbar(){
    ...
    return (
        <div className="bg-[#dde7f5] pt-[50px]">
            <div className=" bg-white mx-[30px] h-[100px] rounded-3xl flex justify-around items-center">
                ...
                <div className="relative hidden md:block ">
                    <input type="search" name="Search" id="" className=" indent-0 bg-[#f5f7fa]  px-5 py-2 rounded-3xl outline-0 border border-slate-300 border-solid" placeholder="Type Something"/>
                    <input type="submit" value="Search" className=" bg-black text-white indent-0 cursor-pointer absolute top-[1px] right-0 rounded-e-3xl py-2 px-3 outline-0"/>
                </div>
                {/* menu icon */}
